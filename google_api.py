...
if __name__ == "__main__":
    ...
    page_limit = 1
    search_word = "あんぱんまん"
    save_dir_path = "static"

    correspondence_table = {}

    img_list = getImageUrl(
        API_KEY, CUSTOM_SEARCH_ENGINE, search_word, page_limit, save_dir_path
    )
    ...
    with open(
        os.path.join(correspondence_table_path, "corr_table.json"), mode="w"
    ) as f:
